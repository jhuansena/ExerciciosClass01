...
const livros = [
    livro1 = new Livro("Madeira Molhada", "Jailson"),
    livro2 = new Livro("Braço Curto", "Shakespeare"),
    livro3 = new Livro("Um bom codante", "Giovany")
]
...
const pessoas = [
    pessoa01 = new Pessoa("Giovany", 24),
    pessoa02 = new Pessoa("Carlos", 35),
    pessoa03 = new Pessoa("Ana", 19)
]
...
class Carro {
    ...
    acelerar() {
        let km = 0 
        for(km; km < 11; km++) {
            console.log(`Carro Acelerando ${km}km`)
        }
    }
}
...
const produtos = [
    produto1 = new Produto("Celular Samsung", 2600),
    produto2 = new Produto("Celular Motorola", 2300),
    produto3 = new Produto("Celular Xiaomi", 2000)
]
...
const animal1 = new Animal("Carlos", "Amarelo","Persa","Gato")
const animal2 = new Animal("Bob", "Marrom","Golden","Cachorro")
const animal3 = new Animal("Faria", "Branco","Calopsita","Passaro")
...
const filme1 = new Filme("Velozes e Furiosos 2", 2007)
const filme2 = new Filme("Backrooms", 2026)
